        ...
        do{
            ...
            switch(opc){
                case 1:{
                    ...
                    //arreglo[i] = new ModeloRiesgo(nombre,confianza);
                    //lista.add(new ModeloRiesgo(nombre,confianza));
                ...
                case 2:{
                    if(mr != null){
                      ...
                      //  arreglo[i].setFactorConfianza(confianza);
                      //  lista.get(i).setFactorConfianza(confianza);
